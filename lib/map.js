...
// RESET POPUP WINDOW
function resetPopup() {
    document.getElementById('popup').innerHTML = '<div id="popupcontent"><br/></div><button class="popupbutton" style="position: absolute; top: 20px; right: 20px;" onclick="closePopup()" title="Close"><img src="lib/hud/close.png" width="20"></button>';
}
...
function reloadMap() {
    // PLAYERS SETTING
    document.getElementById('playerstats').innerHTML = '<strong>Players:</strong> ';
    ...
    document.getElementById('playerstats').innerHTML += '<img src="lib/hud/stats.png" class="buttonimage" alt="Turn" title="Turn"> ' + map.game.turn + ' &nbsp;&nbsp;&nbsp;<img src="lib/hud/time.png" class="buttonimage" alt="Year" title="Year"> ' + map.game.year;
    var len = map.players.length;
    for (i = 0; i < len; i++) {
        var divid = "player" + i;
        var dividquery = "#" + divid;
