...
// INSTRUCTIONS MANUAL
function manual() {
	document.getElementById('popup').innerHTML = 'This is the manual<button class="popupbutton" style="position: absolute; top: 20px; right: 20px;" onclick="closePopup()" title="Close"><img src="lib/hud/close.png" width="20"></button>';
    openPopup();
}
