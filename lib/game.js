...
function attackUnit(unit1, indexunit1, unit2, indexunit2) {
    ...
    content += '<center><span style="color: ' + unit2.color + '"><strong>' + unit2title + unit2.type.toUpperCase() + '</strong></span> deal <strong>' + damage1 + '</strong> damage to <span style="color: ' + unit1.color + '"><strong>' + unit1title + unit1.type.toUpperCase() + '</strong></span><br/>';
