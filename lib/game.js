...
function moveUnit(i) {
    $('td').on('click.moveto', function() {
        ...
        this.innerHTML = document.getElementById(String(map.units[i].x) + String(map.units[i].y)).innerHTML;
        document.getElementById(String(map.units[i].x) + String(map.units[i].y)).innerHTML = "";
